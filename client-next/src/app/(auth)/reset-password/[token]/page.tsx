...
import { validateResetTokenApi, resetPasswordWithTokenApi } from "@/lib/api";
...
type ResetPasswordWithTokenFormData = z.infer<typeof resetPasswordWithTokenSchema>;
...
export default function ResetPasswordTokenPage({
  ...
  const onSubmit = async (data: ResetPasswordWithTokenFormData) => {
    setIsPending(true);
    try {
      await resetPasswordWithTokenApi(token, data.password);
  ...
  return (
    <div className="flex w-full flex-col gap-8">
      <div className="text-center">
        <h1 className="text-xl font-semibold lg:text-2xl">Reset your password</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="relative mt-4">
          <Button
            ...
            disabled={isPending}
          >
            {isPending ? <><Spinner /> Resetting</> : "Reset Password"}
          </Button>
        </div>
      </form>
